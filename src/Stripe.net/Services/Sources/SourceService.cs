namespace Stripe
{
        ...
        IUpdatable<Source, SourceUpdateOptions>
    {
        ...
        public virtual  Detach(string id, SourceDetachOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<undefined>(HttpMethod.Delete, /v1/customers/{customer}/sources/{id}, options, requestOptions);
        }

        public virtual Task<undefined> DetachAsync(string id, SourceDetachOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return this.RequestAsync<undefined>(HttpMethod.Delete, /v1/customers/{customer}/sources/{id}, options, requestOptions, cancellationToken);
        }
        ...
        public virtual Task<ApmsSourcesSourceTransactionList> SourceTransactionsAsync(string id, SourceSourceTransactionsOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual Task<Source> VerifyAsync(string id, SourceVerifyOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
