namespace Stripe
{
        ...
        IUpdatable<Account, AccountUpdateOptions>
    {
        ...
        public virtual  Persons(string id, AccountPersonsOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<undefined>(HttpMethod.Get, $"{this.InstanceUrl(id)}/persons", options, requestOptions);
        }

        public virtual Task<undefined> PersonsAsync(string id, AccountPersonsOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return this.RequestAsync<undefined>(HttpMethod.Get, $"{this.InstanceUrl(id)}/persons", options, requestOptions, cancellationToken);
        }
